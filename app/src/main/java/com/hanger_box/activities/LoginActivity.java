...
//        Log.d(TAG, "signInWithCredential:"+currentUser.getEmail());
    ...
    private void snsLogin(String email, String token, String type) {
        loadingLayout.setVisibility(View.VISIBLE);
        OkHttpClient client = new OkHttpClient();
    ...
    private void facebookByLogin(AccessToken token) {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (user != null) {
                                snsLogin(user.getEmail(), token.getToken(), "FACEBOOK");
    ...
    private void googleByLogin(String idToken) {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            FirebaseUser user = mAuth.getCurrentUser();
                            if (user != null) {
                                snsLogin(user.getEmail(), idToken, "GOOGLE");
                                Log.i(TAG, "email" + user.getEmail());
                            }
                        } else {
                            // If sign in fails, display a message to the user.
    ...
    private void confirmResult (String message) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                loadingLayout.setVisibility(View.GONE);
                                        ...
                                        public void onCompleted(
                                            ...
                                            if (object != null) {
                                                try {
                                                    ...
                                                    facebookByLogin(loginResult.getAccessToken());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                googleByLogin(account.getIdToken());
